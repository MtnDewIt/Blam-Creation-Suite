...
public:
	...
	virtual BCS_RESULT string_id_to_index(string_id string_identifier, uint32_t& string_index) final;
	...
	virtual BCS_RESULT string_id_to_string(string_id string_identifier, const char*& string) final;
