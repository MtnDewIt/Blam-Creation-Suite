...
class c_halo2_cache_file_reader : public c_cache_file_reader
{
public:
	c_halo2_cache_file_reader(const wchar_t* filepath, s_engine_platform_build engine_platform_build);
	~c_halo2_cache_file_reader();
	...
	virtual BCS_RESULT associate_cache_cluster(c_halo2_cache_cluster& cache_cluster);
...
private:
	union
	{
		// #TODO: Add Alpha/Beta header
		s_cache_file_header cache_file_header;
		::halo2::xbox::s_cache_file_header xbox_cache_file_header;
		::halo2::pc32::s_cache_file_header pc32_cache_file_header;
		::halo2::pc64::s_cache_file_header pc64_cache_file_header;
	};
};
