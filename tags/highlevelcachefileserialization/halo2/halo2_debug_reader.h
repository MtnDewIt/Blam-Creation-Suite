...
class c_halo2_debug_reader : public c_debug_reader
{
public:
	c_halo2_debug_reader(c_halo2_cache_cluster& cache_cluster, c_halo2_cache_file_reader& cache_reader);
	~c_halo2_debug_reader();
...
private:
	...
	static constexpr uint32_t string_id_index_bits = 19;
	...
	static constexpr uint32_t string_id_namespace_bits = 6;
	...
	static constexpr uint32_t string_id_length_bits = 7;
	...
	//static constexpr uint32_t k_engine_set_counts[] = { 1585, 2167, 267, 141, 248, 85, 43, 2812, 528, 51, 131, 0, 52, 13, 66, 227 };
	static constexpr uint32_t k_engine_set_counts[] = { 1585, 2165, 267, 141, 248, 71, 43, 2797, 524, 51, 131, 0, 52, 13, 66, 227 };
	static constexpr uint32_t k_engine_string_id_namespace_count = _countof(k_engine_set_counts);
	static constexpr uint32_t k_engine_string_ids_total = compile_time_accumulator(k_engine_set_counts);
