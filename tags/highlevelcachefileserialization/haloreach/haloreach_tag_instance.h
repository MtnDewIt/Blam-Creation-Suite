...
class c_haloreach_tag_instance : public c_tag_instance
{
public:
	friend class c_haloreach_tag_reader;

	c_haloreach_tag_instance(
	...
	BCS_RESULT get_tag_group(c_haloreach_tag_group*& tag_group) const;
