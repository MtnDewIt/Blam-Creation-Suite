...
class c_haloreach_debug_reader : public c_debug_reader
{
public:
	c_haloreach_debug_reader(c_haloreach_cache_cluster& cache_cluster, c_haloreach_cache_file_reader& cache_reader);
	~c_haloreach_debug_reader();
