...
class c_haloreach_cache_file_reader : public c_cache_file_reader
{
public:
	c_haloreach_cache_file_reader(c_haloreach_cache_file_reader const&) = delete;
	BCS_SHARED c_haloreach_cache_file_reader(const wchar_t* filepath, s_engine_platform_build engine_platform_build);
	BCS_SHARED ~c_haloreach_cache_file_reader();
	...
	BCS_SHARED virtual BCS_RESULT associate_cache_cluster(c_haloreach_cache_cluster& cache_cluster) final;
...
private:
	union
	{
		...
		::haloreach::pc::s_cache_file_header pc_cache_file_header;
		::haloreach::xbox360::s_cache_file_header xbox360_cache_file_header;
	};
};
