...
class c_haloreach_tag_group : public c_tag_group
{
public:
	c_haloreach_tag_group(c_haloreach_cache_cluster& cache_cluster, blofeld::s_tag_group const& blofeld_tag_group, c_haloreach_tag_group* parent);
	~c_haloreach_tag_group();
