...
class c_halo3odst_cache_file_reader : public c_cache_file_reader
{
public:
	c_halo3odst_cache_file_reader(c_halo3odst_cache_file_reader const&) = delete;
	BCS_SHARED c_halo3odst_cache_file_reader(const wchar_t* filepath, s_engine_platform_build engine_platform_build);
	BCS_SHARED ~c_halo3odst_cache_file_reader();
	...
	BCS_SHARED virtual BCS_RESULT associate_cache_cluster(c_halo3odst_cache_cluster& cache_cluster) final;
...
private:
	union
	{
		...
		::halo3odst::pc::s_cache_file_header pc_cache_file_header;
		::halo3odst::xbox360::s_cache_file_header xbox360_cache_file_header;
	};
};
