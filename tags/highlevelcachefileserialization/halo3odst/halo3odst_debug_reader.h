...
class c_halo3odst_debug_reader : public c_debug_reader
{
public:
	c_halo3odst_debug_reader(c_halo3odst_cache_cluster& cache_cluster, c_halo3odst_cache_file_reader& cache_reader);
	~c_halo3odst_debug_reader();
