...
class c_halo3odst_tag_group : public c_tag_group
{
public:
	c_halo3odst_tag_group(c_halo3odst_cache_cluster& cache_cluster, blofeld::s_tag_group const& blofeld_tag_group, c_halo3odst_tag_group* parent);
	~c_halo3odst_tag_group();
