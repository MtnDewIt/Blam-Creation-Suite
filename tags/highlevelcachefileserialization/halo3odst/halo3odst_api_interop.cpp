...
static constexpr s_halo3odst_tag_interop_info d3d_vertex_buffer_interop =
{
...
static constexpr s_halo3odst_tag_interop_info d3d_index_buffer_interop =
{
...
static constexpr s_halo3odst_tag_interop_info d3d_texture_interop =
{
	"s_tag_d3d_texture",
...
static constexpr s_halo3odst_tag_interop_info d3d_texture_interleaved_interop =
{
...
static constexpr s_halo3odst_tag_interop_info d3d_vertex_shader_interop =
{
...
static constexpr s_halo3odst_tag_interop_info d3d_pixel_shader_interop =
{
...
static constexpr s_halo3odst_tag_interop_info PolyartVertexBufferInterop =
{
	"PolyartVertexBuffer",
...
static constexpr s_halo3odst_tag_interop_info VectorartVertexBufferInterop =
{
	"PolyartVertexBuffer",
...
static constexpr s_halo3odst_tag_interop_info PolyartIndexBufferInterop =
{
	"PolyartIndexBuffer",
...
const s_halo3odst_tag_interop_info halo3odst_tag_interop_infos[k_num_halo3odst_interop_types] =
{
...
c_halo3odst_interop_container::c_halo3odst_interop_container(e_halo3odst_interop_type type, uint32_t descriptor, const void* data) :
	//h_interop(),
	type(type),
...
c_halo3odst_interop_container::~c_halo3odst_interop_container()
{

}

c_halo3odst_vectorart_vertex_buffer_interop::c_halo3odst_vectorart_vertex_buffer_interop(c_halo3odst_tag_reader& tag_reader, uint32_t descriptor, const void* data) :
	c_halo3odst_interop_container(_halo3odst_vectorart_vertex_buffer_interop, descriptor, data),
	vertex_data(),
	vertex_data_size()
{
...
c_halo3odst_vectorart_vertex_buffer_interop::~c_halo3odst_vectorart_vertex_buffer_interop()
{

}

c_halo3odst_polyart_vertex_buffer_interop::c_halo3odst_polyart_vertex_buffer_interop(c_halo3odst_tag_reader& tag_reader, uint32_t descriptor, const void* data) :
	c_halo3odst_interop_container(_halo3odst_polyart_vertex_buffer_interop, descriptor, data),
	vertex_data(),
	vertex_data_size(),
	vertex_type()
{
...
c_halo3odst_polyart_vertex_buffer_interop::~c_halo3odst_polyart_vertex_buffer_interop()
{
	tracked_free(vertex_data);
}

c_halo3odst_polyart_index_buffer_interop::c_halo3odst_polyart_index_buffer_interop(c_halo3odst_tag_reader& tag_reader, uint32_t descriptor, const void* data) :
	c_halo3odst_interop_container(_halo3odst_polyart_index_buffer_interop, descriptor, data),
	index_data(),
	index_data_size()
{
	// #TODO: reexport halo 4 interops
...
c_halo3odst_polyart_index_buffer_interop::~c_halo3odst_polyart_index_buffer_interop()
{
