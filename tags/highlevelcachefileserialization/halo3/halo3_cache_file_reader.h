...
{
public:
	c_halo3_cache_file_reader(c_halo3_cache_file_reader const&) = delete;
	BCS_SHARED c_halo3_cache_file_reader(const wchar_t* filepath, s_engine_platform_build engine_platform_build);
	BCS_SHARED ~c_halo3_cache_file_reader();
	...
	BCS_SHARED virtual BCS_RESULT associate_cache_cluster(c_halo3_cache_cluster& cache_cluster) final;
