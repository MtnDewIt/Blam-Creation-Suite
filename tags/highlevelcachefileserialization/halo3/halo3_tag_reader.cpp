...
c_halo3_tag_reader::c_halo3_tag_reader(c_halo3_cache_cluster& _cache_cluster, c_halo3_cache_file_reader& _cache_reader) :
...
BCS_RESULT c_halo3_tag_reader::read_tags_header()
{
	...
	case _platform_type_xbox_one:
		xboxone_tags_header = *reinterpret_cast<const ::halo3::xboxone::s_cache_file_tags_header*>(tag_section_buffer.begin + tags_header_relative_offset);
		if (xboxone_tags_header.signature != 'tags') 
		{
			return BCS_E_FAIL;
		}
		break;
...
BCS_RESULT c_halo3_tag_reader::get_tag_groups_section(s_halo3_section& tag_groups)
{
	switch (cache_cluster.engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit: 
	...
	case _platform_type_xbox_one: 
	{
		tag_groups.count = xboxone_tags_header.tag_groups.count;
		tag_groups.address = xboxone_tags_header.tag_groups.address;
		return BCS_S_OK;
	}
	default:
		return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_tag_reader::get_tag_instances_section(s_halo3_section& tag_instances)
{
	switch (cache_cluster.engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit: 
	...
	case _platform_type_xbox_one: 
	{
		tag_instances.count = xboxone_tags_header.tag_instances.count;
		tag_instances.address = xboxone_tags_header.tag_instances.address;
		return BCS_S_OK;
	}
	default:
		return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_tag_reader::get_global_tag_instances_section(s_halo3_section& global_tag_instances)
{
	switch (cache_cluster.engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit: 
	...
	case _platform_type_xbox_one: 
	{
		global_tag_instances.count = xboxone_tags_header.global_tag_indices.count;
		global_tag_instances.address = xboxone_tags_header.global_tag_indices.address;
		return BCS_S_OK;
	}
	default:
		return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_tag_reader::get_tag_interop_table_section(s_halo3_section& tag_interop_table)
{
	switch (cache_cluster.engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit: 
	...
	case _platform_type_xbox_one:
	{
		tag_interop_table.count = xboxone_tags_header.tag_interop_fixups.count;
		tag_interop_table.address = xboxone_tags_header.tag_interop_fixups.address;
		return BCS_S_OK;
	}
	default:
		return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_tag_reader::read_tag_groups()
{
	...
	s_halo3_section tag_groups_section;
...
BCS_RESULT c_halo3_tag_reader::read_tag_instances()
{
	...
	s_halo3_section tag_instances_section;
...
BCS_RESULT c_halo3_tag_reader::read_tag_global_instances()
{
	...
	s_halo3_section global_tag_instances_section;
...
BCS_RESULT c_halo3_tag_reader::read_tag_interops()
{
	...
	s_halo3_section tag_interop_table_section;
	...
	const s_halo3_tag_interop_type_fixup* tag_interops_read_pointer = reinterpret_cast<const s_halo3_tag_interop_type_fixup*>(tag_section_buffer.begin + tag_interops_relative_offset);
...
BCS_RESULT c_halo3_tag_reader::get_tag_group_by_blofeld_tag_group(const s_tag_group& in_blofeld_tag_group, c_halo3_tag_group*& out_tag_group) const
{
	for (c_halo3_tag_group* tag_group : tag_groups)
	{
		s_tag_group const* blofeld_tag_group;
...
BCS_RESULT c_halo3_tag_reader::get_tag_group_info_by_blofeld_tag_group(const s_tag_group& blofeld_tag_group, s_halo3_tag_group_info*& out_tag_group_info)
{
	for (s_halo3_tag_group_info& tag_group_info : tag_group_infos)
	{
...
BCS_RESULT c_halo3_tag_reader::get_instance_info_by_tag_index(uint32_t tag_index, const s_halo3_tag_instance_info*& instance_info)
{
...
BCS_RESULT c_halo3_tag_reader::get_tag_instance_info_by_tag_index(uint32_t tag_index, c_halo3_tag_instance*& tag_instance)
{
...
BCS_RESULT c_halo3_tag_reader::page_offset_to_pointer(int32_t page_offset, const void*& data)
{
	BCS_RESULT rs = BCS_S_OK;
...
BCS_RESULT c_halo3_tag_reader::get_tag_groups(c_halo3_tag_group**& out_tag_groups, uint32_t& out_tag_group_count)
{
...
BCS_RESULT c_halo3_tag_reader::get_tag_groups(c_tag_group**& out_tag_groups, uint32_t& out_tag_group_count)
{
...
BCS_RESULT c_halo3_tag_reader::get_tag_instances(c_halo3_tag_instance**& out_tag_instances, uint32_t& out_tag_instance_count)
{
...
BCS_RESULT c_halo3_tag_reader::get_tag_instances(c_tag_instance**& out_tag_instances, uint32_t& out_tag_instance_count)
{
...
BCS_RESULT c_halo3_tag_reader::get_tag_instance_by_cache_file_tag_index(uint32_t cache_file_tag_index, c_tag_instance*& out_tag_instance)
{
	BCS_RESULT rs = BCS_S_OK;
...
BCS_RESULT c_halo3_tag_reader::init_interop_table()
{
	...
	//	for (uint32_t resource_type_index = 0; resource_type_index < k_num_halo3_resource_types; resource_type_index++)
	//	{
...
BCS_RESULT c_halo3_tag_reader::init_interops()
{
	...
	{
		s_halo3_tag_interop_type_fixup& cache_file_tag_interop_entry = tag_interop_infos[interop_index];
...
BCS_RESULT c_halo3_tag_reader::interop_type_index_to_halo3_interop_type(int32_t type_index, e_halo3_interop_type& interop_type)
{
...
BCS_RESULT c_halo3_tag_reader::init_resource_table()
{
	...
	for (uint32_t index = 0; index < resource_gestalt.interop_type_identifiers_block.count; index++)
	{
		...
		for (uint32_t interop_type_index = 0; interop_type_index < k_num_halo3_interop_types; interop_type_index++)
		{
...
BCS_RESULT c_halo3_tag_reader::shared_file_index_to_cache_file_reader(int32_t shared_file_index, c_halo3_cache_file_reader*& cache_file_reader)
{
...
BCS_RESULT c_halo3_tag_reader::get_interop_container_by_type_and_descriptor(e_halo3_interop_type interop_type, uint32_t descriptor, c_halo3_interop_container*& interop_container)
{
...
BCS_RESULT c_halo3_tag_reader::get_compression_codec_by_index(int32_t codec_index, e_halo3_compression_codec& compression_codec)
{
	BCS_RESULT rs = BCS_S_OK;
