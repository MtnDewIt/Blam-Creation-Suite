...
BCS_RESULT c_halo3_cache_file_reader::get_build_info(s_cache_file_build_info& build_info) const
{
	...
	case _platform_type_pc_64bit:
	{
		...
		if (BCS_FAILED(rs = halo3::halo3_scenario_type_to_base_scenario_type(pc_cache_file_header.scenario_type, build_info.scenario_type)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo3::halo3_cache_file_shared_file_type_to_base_cache_file_shared_file_type(pc_cache_file_header.shared_cache_file_type, build_info.shared_cache_file_type)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo3::halo3_cache_file_header_flags_to_base_cache_file_header_flags(pc_cache_file_header.header_flags, build_info.header_flags)))
		{
			return rs;
		}
	...
	case _platform_type_xbox_360:
	{
		...
		if (BCS_FAILED(rs = halo3::halo3_scenario_type_to_base_scenario_type(xbox360_cache_file_header.scenario_type, build_info.scenario_type)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo3::halo3_cache_file_shared_file_type_to_base_cache_file_shared_file_type(xbox360_cache_file_header.shared_cache_file_type, build_info.shared_cache_file_type)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo3::halo3_cache_file_header_flags_to_base_cache_file_header_flags(xbox360_cache_file_header.header_flags, build_info.header_flags)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo3::halo3_cache_file_shared_file_flags_to_base_cache_file_shared_file_flags(xbox360_cache_file_header.shared_map_usage, build_info.shared_map_usage)))
		{
			return rs;
		}
	...
	case _platform_type_xbox_one: 
	{
		...
		if (BCS_FAILED(rs = halo3::halo3_scenario_type_to_base_scenario_type(xboxone_cache_file_header.scenario_type, build_info.scenario_type)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo3::halo3_cache_file_shared_file_type_to_base_cache_file_shared_file_type(xboxone_cache_file_header.shared_cache_file_type, build_info.shared_cache_file_type)))
		{
			return rs;
		}
		build_info.header_flags.clear(); // #TODO: handle build info header_flags
		if (BCS_FAILED(rs = halo3::halo3_cache_file_shared_file_flags_to_base_cache_file_shared_file_flags(xboxone_cache_file_header.shared_map_usage, build_info.shared_map_usage)))
		{
			return rs;
		}
...
BCS_RESULT c_halo3_cache_file_reader::get_section_buffer(e_cache_file_section section_index, s_cache_file_buffer_info& buffer_info) const
{
...
BCS_RESULT c_halo3_cache_file_reader::get_string_id_count(int32_t& string_id_count) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		string_id_count = xboxone_cache_file_header.string_id_count;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_cache_file_reader::get_string_id_index_offset(int32_t& string_id_index_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		string_id_index_offset = xboxone_cache_file_header.string_id_index_offset;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_cache_file_reader::get_string_id_data_offset(int32_t& string_id_data_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		string_id_data_offset = xboxone_cache_file_header.string_id_data_offset;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_cache_file_reader::get_string_id_data_count(int32_t& string_id_data_count) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		string_id_data_count = xboxone_cache_file_header.string_id_data_count;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_cache_file_reader::get_debug_tag_name_count(int32_t& debug_tag_name_count) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		debug_tag_name_count = xboxone_cache_file_header.debug_tag_name_count;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_cache_file_reader::get_debug_tag_name_index_offset(int32_t& debug_tag_name_index_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		debug_tag_name_index_offset = xboxone_cache_file_header.debug_tag_name_index_offset;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_cache_file_reader::get_debug_tag_name_data_offset(int32_t& debug_tag_name_data_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		debug_tag_name_data_offset = xboxone_cache_file_header.debug_tag_name_data_offset;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
...
BCS_RESULT c_halo3_cache_file_reader::get_debug_tag_name_data_size(int32_t& debug_tag_name_data_size) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
	...
	case _platform_type_xbox_one:
	{
		debug_tag_name_data_size = xboxone_cache_file_header.debug_tag_name_data_size;
		return BCS_S_OK;
	}
	break;
	default: return BCS_E_UNSUPPORTED;
