...
class c_groundhog_tag_instance : public c_tag_instance
{
public:
	friend class c_groundhog_tag_reader;

	c_groundhog_tag_instance(
	...
	BCS_RESULT get_tag_group(c_groundhog_tag_group*& tag_group) const;
