...
class c_groundhog_tag_group : public c_tag_group
{
public:
	c_groundhog_tag_group(c_groundhog_cache_cluster& cache_cluster, const blofeld::s_tag_group& blofeld_tag_group, c_groundhog_tag_group* parent);
	~c_groundhog_tag_group();
