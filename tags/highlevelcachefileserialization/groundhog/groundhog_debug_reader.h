...
class c_groundhog_debug_reader : public c_debug_reader
{
public:
	c_groundhog_debug_reader(c_groundhog_cache_cluster& cache_cluster, c_groundhog_cache_file_reader& cache_reader);
	~c_groundhog_debug_reader();
