...
public:
	...
	BCS_RESULT get_tag_groups(c_halo4_tag_group**& tag_groups, uint32_t& tag_group_count);
	virtual BCS_RESULT get_tag_groups(c_tag_group**& tag_groups, uint32_t& tag_group_count) override;
	BCS_RESULT get_tag_instances(c_halo4_tag_instance**& tag_instances, uint32_t& tag_instance_count);
...
private:
	...
	using t_tag_instances_by_index = std::unordered_map<uint32_t, c_halo4_tag_instance*>;
	...
	BCS_RESULT interop_type_index_to_halo4_interop_type(int32_t type_index, e_halo4_interop_type& interop_type);
	...
	BCS_RESULT get_interop_container_by_type_and_descriptor(e_halo4_interop_type interop_type, uint32_t descriptor, c_halo4_interop_container*& interop_container);

	BCS_RESULT get_compression_codec_by_index(int32_t codec_index, e_halo4_compression_codec& compression_codec);
