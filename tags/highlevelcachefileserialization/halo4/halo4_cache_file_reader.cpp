	...
	cache_file_header()
{
	...
	{
		xbox360_cache_file_header = *reinterpret_cast<halo4::xbox360::s_cache_file_header*>(file_info.file_view_begin);
...
BCS_RESULT c_halo4_cache_file_reader::get_build_info(s_cache_file_build_info& build_info) const
{
	...
	case _platform_type_xbox_360:
	{
		...
		if (BCS_FAILED(rs = halo4::halo4_scenario_type_to_base_scenario_type(xbox360_cache_file_header.scenario_type, build_info.scenario_type)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo4::halo4_cache_file_shared_file_type_to_base_cache_file_shared_file_type(xbox360_cache_file_header.shared_cache_file_type, build_info.shared_cache_file_type)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo4::halo4_cache_file_header_flags_to_base_cache_file_header_flags(xbox360_cache_file_header.header_flags, build_info.header_flags)))
		{
			return rs;
		}
		if (BCS_FAILED(rs = halo4::halo4_cache_file_shared_file_flags_to_base_cache_file_shared_file_flags(xbox360_cache_file_header.shared_map_usage, build_info.shared_map_usage)))
		{
			return rs;
		}
...
BCS_RESULT c_halo4_cache_file_reader::get_section_buffer(e_cache_file_section section_index, s_cache_file_buffer_info& buffer_info) const
{
...
BCS_RESULT c_halo4_cache_file_reader::get_blofeld_tag_groups(blofeld::t_tag_group_collection& tag_groups) const
{
	return blofeld::tag_definition_registry_get_tag_groups_by_engine_platform_build(engine_platform_build, tag_groups);
}

BCS_RESULT c_halo4_cache_file_reader::get_tags_header_relative_offset(int32_t& tags_header_relative_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_string_id_count(int32_t& string_id_count) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_string_id_index_offset(int32_t& string_id_index_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_string_id_data_offset(int32_t& string_id_data_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_string_id_data_count(int32_t& string_id_data_count) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_debug_tag_name_count(int32_t& debug_tag_name_count) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_debug_tag_name_index_offset(int32_t& debug_tag_name_index_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_debug_tag_name_data_offset(int32_t& debug_tag_name_data_offset) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
...
BCS_RESULT c_halo4_cache_file_reader::get_debug_tag_name_data_size(int32_t& debug_tag_name_data_size) const
{
	switch (engine_platform_build.platform_type)
	{
	case _platform_type_pc_64bit:
