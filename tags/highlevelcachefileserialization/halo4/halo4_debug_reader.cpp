	...
	debug_tag_name_index_buffer()
{
	...
	//aes128_decrypt(encrypted_string_id_buffer, string_id_buffer, string_id_data_count, c_halo4_cache_file_reader::k_string_id_encryption_key);
	...
	//aes128_decrypt(encrypted_file_table_buffer, debug_tag_name_buffer, debug_tag_name_data_size, c_halo4_cache_file_reader::k_file_name_encryption_key);
}
