...
#if defined(BCS_BUILD_HIGH_LEVEL_HALO4) || defined(BCS_BUILD_HIGH_LEVEL_GROUNDHOG)
...
template<> BCS_SHARED void byteswap_inplace(halo4::s_cache_file_section_file_bounds& value)
{
	byteswap_inplace(value.offset);
	byteswap_inplace(value.size);
}

template<> BCS_SHARED void byteswap_inplace(halo4::s_cache_file_local_resource_location& value)
{
...
template<> BCS_SHARED void byteswap_inplace(halo4::s_cache_file_insertion_point_resource_usage& value)
{
...
template<> BCS_SHARED void byteswap_inplace(halo4::s_cache_file_shared_resource_usage& value)
{
...
template<> BCS_SHARED void byteswap_inplace(halo4::xbox360::s_cache_file_tag_interop_type_fixup& tag_interop)
{
	byteswap_inplace(tag_interop.interop_address);
	byteswap_inplace(tag_interop.cache_file_interop_type);
}

template<> BCS_SHARED void byteswap_inplace(halo4::xbox360::s_section& section)
{
	byteswap_inplace(section.count);
	byteswap_inplace(section.address);
}
...
namespace halo4
{
	BCS_SHARED BCS_RESULT halo4_scenario_type_to_base_scenario_type(e_scenario_type halo4_scenario_type, ::e_scenario_type& base_scenario_type)
	{
		switch (halo4_scenario_type)
		{
		case halo4::_scenario_type_invalid:
			base_scenario_type = ::_scenario_type_invalid;
			return BCS_S_OK;
		case halo4::_scenario_type_solo:
			base_scenario_type = ::_scenario_type_solo;
			return BCS_S_OK;
		case halo4::_scenario_type_multiplayer:
			base_scenario_type = ::_scenario_type_multiplayer;
			return BCS_S_OK;
		case halo4::_scenario_type_main_menu:
			base_scenario_type = ::_scenario_type_main_menu;
			return BCS_S_OK;
		case halo4::_scenario_type_multiplayer_shared:
			base_scenario_type = ::_scenario_type_multiplayer_shared;
			return BCS_S_OK;
		case halo4::_scenario_type_single_player_shared:
			base_scenario_type = ::_scenario_type_single_player_shared;
			return BCS_S_OK;
		case halo4::_scenario_type_sounds_shared:
	...
	BCS_SHARED BCS_RESULT base_scenario_type_to_halo4_scenario_type(::e_scenario_type base_scenario_type, e_scenario_type& halo4_scenario_type)
	{
		switch (base_scenario_type)
		{
		case ::_scenario_type_invalid:
			halo4_scenario_type = halo4::_scenario_type_invalid;
			return BCS_S_OK;
		case ::_scenario_type_solo:
			halo4_scenario_type = halo4::_scenario_type_solo;
			return BCS_S_OK;
		case ::_scenario_type_multiplayer:
			halo4_scenario_type = halo4::_scenario_type_multiplayer;
			return BCS_S_OK;
		case ::_scenario_type_main_menu:
			halo4_scenario_type = halo4::_scenario_type_main_menu;
			return BCS_S_OK;
		case ::_scenario_type_multiplayer_shared:
			halo4_scenario_type = halo4::_scenario_type_multiplayer_shared;
			return BCS_S_OK;
		case ::_scenario_type_single_player_shared:
			halo4_scenario_type = halo4::_scenario_type_single_player_shared;
			return BCS_S_OK;
		case ::_scenario_type_sounds_shared:
			halo4_scenario_type = halo4::_scenario_type_sounds_shared;
			return BCS_S_OK;
		}
		return BCS_E_UNSUPPORTED;
	}

	BCS_SHARED BCS_RESULT halo4_cache_file_shared_file_type_to_base_cache_file_shared_file_type(e_cache_file_shared_file_type halo4_cache_file_shared_file_type, ::e_cache_file_shared_file_type& base_cache_file_shared_file_type)
	{
		// #TODO: Handle pc64 shared file type (its different for some reason)
		switch (halo4_cache_file_shared_file_type)
		{
		case halo4::k_invalid_shared_file_type:
			base_cache_file_shared_file_type = ::k_invalid_shared_file_type;
			return BCS_S_OK;
		case halo4::_shared_file_mainmenu:
			base_cache_file_shared_file_type = ::_shared_file_mainmenu;
			return BCS_S_OK;
		case halo4::_shared_file_multiplayer:
			base_cache_file_shared_file_type = ::_shared_file_multiplayer;
			return BCS_S_OK;
		case halo4::_shared_file_campaign:
	...
	BCS_SHARED BCS_RESULT base_cache_file_shared_file_type_to_halo4_cache_file_shared_file_type(::e_cache_file_shared_file_type base_cache_file_shared_file_type, e_cache_file_shared_file_type& halo4_cache_file_shared_file_type)
	{
		// #TODO: Handle pc64 shared file type (its different for some reason)
		switch (base_cache_file_shared_file_type)
		{
		case ::k_invalid_shared_file_type:
			halo4_cache_file_shared_file_type = halo4::k_invalid_shared_file_type;
			return BCS_S_OK;
		case ::_shared_file_mainmenu:
			halo4_cache_file_shared_file_type = halo4::_shared_file_mainmenu;
			return BCS_S_OK;
		case ::_shared_file_multiplayer:
			halo4_cache_file_shared_file_type = halo4::_shared_file_multiplayer;
			return BCS_S_OK;
		case ::_shared_file_campaign:
			halo4_cache_file_shared_file_type = halo4::_shared_file_campaign;
			return BCS_S_OK;
		}
		return BCS_E_UNSUPPORTED;
	}
