...
namespace gen3
{
	...
	inline BCS_RESULT gen3_cache_file_shared_file_flags_to_base_cache_file_shared_file_flags(
		c_flags_no_init<gen3::e_cache_file_shared_file_type, t_gen3_storage, k_number_of_shared_file_types> const& gen3_cache_file_shared_file_flags,
		c_flags_no_init<::e_cache_file_shared_file_type, t_base_storage, ::k_number_of_shared_file_types>& base_cache_file_shared_file_flags)
	{
		...
		base_cache_file_shared_file_flags.set(::_shared_file_mainmenu, gen3_cache_file_shared_file_flags.test(_shared_file_mainmenu));
		base_cache_file_shared_file_flags.set(::_shared_file_multiplayer, gen3_cache_file_shared_file_flags.test(_shared_file_multiplayer));
		base_cache_file_shared_file_flags.set(::_shared_file_campaign, gen3_cache_file_shared_file_flags.test(_shared_file_campaign));
		return BCS_S_OK;
	}
	template<typename t_gen3_storage, typename t_base_storage>
	inline BCS_RESULT base_cache_file_shared_file_flags_to_gen3_cache_file_shared_file_flags(
		...
		c_flags_no_init<gen3::e_cache_file_shared_file_type, t_gen3_storage, k_number_of_shared_file_types>& gen3_cache_file_shared_file_flags)
	{
		gen3_cache_file_shared_file_flags.clear();
		gen3_cache_file_shared_file_flags.set(::_shared_file_mainmenu, base_cache_file_shared_file_flags.test(_shared_file_mainmenu));
		gen3_cache_file_shared_file_flags.set(::_shared_file_multiplayer, base_cache_file_shared_file_flags.test(_shared_file_multiplayer));
		gen3_cache_file_shared_file_flags.set(::_shared_file_campaign, base_cache_file_shared_file_flags.test(_shared_file_campaign));
		return BCS_S_OK;
	}
