...
#pragma pack(push, 8)
		struct s_cache_file_header
		{
			...
			c_flags_no_init<halo3odst::e_cache_file_header_bit, unsigned char, halo3odst::k_num_cache_file_header_bits> header_flags;
			...
			int8_t padding[4480]; // There is definitely more data in the padding. No clue what or where tho
