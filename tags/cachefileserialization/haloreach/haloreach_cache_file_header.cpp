...
template<> BCS_SHARED void byteswap_inplace(haloreach::s_cache_file_section_file_bounds& value)
{
	byteswap_inplace(value.offset);
	byteswap_inplace(value.size);
}

template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::alpha::s_cache_file_local_resource_location& value)
{
...
template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::alpha::s_cache_file_insertion_point_resource_usage& value)
{
...
template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::alpha::s_cache_file_shared_resource_usage& value)
{
...
template<> BCS_SHARED void byteswap_inplace(haloreach::s_cache_file_local_resource_location & value)
{
	// #TODO: Handle byteswapping bitfields
	//byteswap_inplace(value.flags);
	//byteswap_inplace(value.file_size);
...
template<> BCS_SHARED void byteswap_inplace(haloreach::s_cache_file_insertion_point_resource_usage& value)
{
	byteswap_inplace(value.initial_zone_set_index);
	byteswap_inplace(value.pad);
	byteswap_inplace(value.shared_required_locations);
...
template<> BCS_SHARED void byteswap_inplace(haloreach::s_cache_file_shared_resource_usage& value)
{
	byteswap_inplace(value.shared_layout_identifier);
	byteswap_inplace(value.shared_location_count);
	byteswap_inplace(value.local_location_count);
...
template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::alpha::s_cache_file_header& value) 
{
...
template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::s_cache_file_header& value)
{
	byteswap_inplace(value.header_signature);
	byteswap_inplace(value.version);
	byteswap_inplace(value.size);
...
template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::s_cache_file_tag_interop_type_fixup& value)
{
	byteswap_inplace(value.interop_address);
	byteswap_inplace(value.cache_file_interop_type);
}

template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::s_section& value)
{
	byteswap_inplace(value.count);
	byteswap_inplace(value.address);
}

template<> BCS_SHARED void byteswap_inplace(haloreach::s_cache_file_tag_group& tag_group)
{
...
template<> BCS_SHARED void byteswap_inplace(haloreach::s_cache_file_tag_instance& tag_instance)
{
...
template<> BCS_SHARED void byteswap_inplace(haloreach::s_cache_file_global_tag_index& tag_global_instance)
{
	byteswap_inplace(tag_global_instance.group_tag);
	byteswap_inplace(tag_global_instance.tag_index);
}

template<> BCS_SHARED void byteswap_inplace(haloreach::xbox360::s_cache_file_tags_header& tags_header)
{
...
namespace haloreach 
{
	BCS_SHARED BCS_RESULT haloreach_scenario_type_to_base_scenario_type(e_scenario_type haloreach_scenario_type, ::e_scenario_type& base_scenario_type)
	{
		switch (haloreach_scenario_type)
		{
		case haloreach::_scenario_type_invalid:
			base_scenario_type = ::_scenario_type_invalid;
			return BCS_S_OK;
		case haloreach::_scenario_type_solo:
			base_scenario_type = ::_scenario_type_solo;
			return BCS_S_OK;
		case haloreach::_scenario_type_multiplayer:
			base_scenario_type = ::_scenario_type_multiplayer;
			return BCS_S_OK;
		case haloreach::_scenario_type_main_menu:
			base_scenario_type = ::_scenario_type_main_menu;
			return BCS_S_OK;
		case haloreach::_scenario_type_multiplayer_shared:
			base_scenario_type = ::_scenario_type_multiplayer_shared;
			return BCS_S_OK;
		case haloreach::_scenario_type_single_player_shared:
			base_scenario_type = ::_scenario_type_single_player_shared;
			return BCS_S_OK;
		case haloreach::_scenario_type_sounds_shared:
	...
	BCS_SHARED BCS_RESULT base_scenario_type_to_haloreach_scenario_type(::e_scenario_type base_scenario_type, e_scenario_type& haloreach_scenario_type)
	{
		switch (base_scenario_type)
		{
		case ::_scenario_type_invalid:
			haloreach_scenario_type = haloreach::_scenario_type_invalid;
			return BCS_S_OK;
		case ::_scenario_type_solo:
			haloreach_scenario_type = haloreach::_scenario_type_solo;
			return BCS_S_OK;
		case ::_scenario_type_multiplayer:
			haloreach_scenario_type = haloreach::_scenario_type_multiplayer;
			return BCS_S_OK;
		case ::_scenario_type_main_menu:
			haloreach_scenario_type = haloreach::_scenario_type_main_menu;
			return BCS_S_OK;
		case ::_scenario_type_multiplayer_shared:
			haloreach_scenario_type = haloreach::_scenario_type_multiplayer_shared;
			return BCS_S_OK;
		case ::_scenario_type_single_player_shared:
			haloreach_scenario_type = haloreach::_scenario_type_single_player_shared;
			return BCS_S_OK;
		case ::_scenario_type_sounds_shared:
			haloreach_scenario_type = haloreach::_scenario_type_sounds_shared;
			return BCS_S_OK;
		}
		return BCS_E_UNSUPPORTED;
	}

	BCS_SHARED BCS_RESULT haloreach_cache_file_shared_file_type_to_base_cache_file_shared_file_type(e_cache_file_shared_file_type haloreach_cache_file_shared_file_type, ::e_cache_file_shared_file_type& base_cache_file_shared_file_type)
	{
		// #TODO: Handle pc64 shared file type (its different for some reason)
		switch (haloreach_cache_file_shared_file_type)
		{
		case haloreach::k_invalid_shared_file_type:
			base_cache_file_shared_file_type = ::k_invalid_shared_file_type;
			return BCS_S_OK;
		case haloreach::_shared_file_mainmenu:
			base_cache_file_shared_file_type = ::_shared_file_mainmenu;
			return BCS_S_OK;
		case haloreach::_shared_file_multiplayer:
			base_cache_file_shared_file_type = ::_shared_file_multiplayer;
			return BCS_S_OK;
		case haloreach::_shared_file_campaign:
	...
	BCS_SHARED BCS_RESULT base_cache_file_shared_file_type_to_haloreach_cache_file_shared_file_type(::e_cache_file_shared_file_type base_cache_file_shared_file_type, e_cache_file_shared_file_type& haloreach_cache_file_shared_file_type)
	{
		// #TODO: Handle pc64 shared file type (its different for some reason)
		switch (base_cache_file_shared_file_type)
		{
		case ::k_invalid_shared_file_type:
			haloreach_cache_file_shared_file_type = haloreach::k_invalid_shared_file_type;
			return BCS_S_OK;
		case ::_shared_file_mainmenu:
			haloreach_cache_file_shared_file_type = haloreach::_shared_file_mainmenu;
			return BCS_S_OK;
		case ::_shared_file_multiplayer:
			haloreach_cache_file_shared_file_type = haloreach::_shared_file_multiplayer;
			return BCS_S_OK;
		case ::_shared_file_campaign:
			haloreach_cache_file_shared_file_type = haloreach::_shared_file_campaign;
			return BCS_S_OK;
		}
		return BCS_E_UNSUPPORTED;
	}
