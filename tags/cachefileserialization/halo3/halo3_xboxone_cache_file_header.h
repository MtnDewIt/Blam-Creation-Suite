...
#pragma pack(push, 8)
		struct s_cache_file_header
		{
			...
			c_flags_no_init<halo3::e_cache_file_shared_file_type, unsigned char, halo3::k_number_of_shared_file_types> shared_map_usage; // k_number_of_shared_file_types == 4 on xbox one
